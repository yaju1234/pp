...
public class PairFeedLikeAdapter extends ArrayAdapter<Like>{
	...
	public PairFeedLikeAdapter(ListPairFeedAdapter listPairFeedAdapter,Activity activity, int textViewResourceId,	ArrayList<Like> items) {
