...
public class InnerTabCommentAdapter extends ArrayAdapter<Comments>{
	...
	int pos;
	public InnerTabCommentAdapter(int pos,TextView lbl_total_comments,InnerListPairFeedAdapter listPairFeedAdapter,String user_id,String post_id,Activity activity, int textViewResourceId,	ArrayList<Comments> items) {
	...
	mHolder.ll_row.setOnLongClickListener(new OnLongClickListener() {
			...
			if((mItems.get(position).getId().equalsIgnoreCase(Constant.userId))){
			    ...
			    System.out.println("!-- user_id "+Constant.userId );
