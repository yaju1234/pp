...
public class PairFeedCommentAdapter extends ArrayAdapter<Comments>{
	...
	private ListPairFeedAdapter listPairFeedAdapter;
	TextView lbl_total_comments;
	int pos;
	public PairFeedCommentAdapter(int pos,TextView lbl_total_comments,ListPairFeedAdapter listPairFeedAdapter,String user_id,String post_id,Activity activity, int textViewResourceId,	ArrayList<Comments> items) {
		super(activity, textViewResourceId, items);
		this.pos = pos;
		this.lbl_total_comments = lbl_total_comments;
		this.mItems = items;
		...
		@Override
	  	...
	  	protected void onPostExecute(Boolean result) {
	  	   ...
	  	   if(result){
	  		 ...
	  		 Constant.feedArr.get(pos).setTotalComments(""+mItems.size());
	  	  	 lbl_total_comments.setText(""+mItems.size());
	  	       }
	  	       notifyDataSetChanged();
	  	       listPairFeedAdapter.notifyDataSetChanged();
	  	   }
